...
description: 审查 duo-harness 仓库的代码变更、提交或 PR 时使用。将审查者定向到本仓库的标准（文档同步要求、证据要求、依赖政策）与代码本身看不出来的检查项。语义审查优先于风格：一条有实证的 blocker 胜过一堆风格 nit。当用户说"审查一下"、"review 这个改动"、"看看这次提交有没有问题"时触发。
---
