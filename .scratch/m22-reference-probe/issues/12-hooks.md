...
**What to build:** 事件面、exit 2 阻断语义、超时、载荷、信任与审查状态机。两家各一份五段模板文档，落 docs/research/<别名>/扩展机制/。

**对应关系：** DSH hook-protocol+claude-code/codex 双桥 ↔ ZCode core/hooks+workspace 信任链
