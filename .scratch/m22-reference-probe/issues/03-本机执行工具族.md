...
**What to build:** 读/写/编辑/glob/grep、shell 执行与持久会话、进程 spawn 与树收割、PTY 终端。两家各一份五段模板文档，落 docs/research/<别名>/工具系统/。

**对应关系：** DSH fs/shell/subprocess/terminal ↔ ZCode exec+fs adapters+node-pty
