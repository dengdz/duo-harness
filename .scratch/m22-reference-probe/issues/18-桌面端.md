...
**What to build:** Electron 进程模型、窗口/托盘/deep link/自动更新、宿主进程与 RPC 桥、OS 集成面。两家各一份五段模板文档，落 docs/research/<别名>/呈现与UI/。

**对应关系：** DSH desktop/desktop-host ↔ ZCode desktop+host 进程
